This is a plugin that provides an easy way to copy to the clipboard the Prototype link to specific frames without having to switch into the Presentation mode.
